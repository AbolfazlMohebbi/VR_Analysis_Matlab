function QS = QuietStance_AllExp(data , fc, tQS , flag, calibParam_path)
...
[dLeftSh,dRightSh,dHip] = LasDisQS_App_AllExp(vLeft(LasDel:end),vRight(LasDel:end),vHip(LasDel:end), calibParam_path);
