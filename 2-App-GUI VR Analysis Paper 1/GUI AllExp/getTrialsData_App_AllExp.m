function Trials_Data = getTrialsData_App_AllExp(SubjIndex, Subject_data, flb_file_path, data, trialsMatrix, VelCase, AmpCase)
...
% Quiet Stance
calibParam_path = 'D:\StashVR\VR_Analysis_Matlab\CalibrationParams';
QSdata = flb2mat(flb_file_path,'read_case',QS_trial_number);
QS = QuietStance_AllExp(QSdata , fc , tQS , 'N', calibParam_path);
