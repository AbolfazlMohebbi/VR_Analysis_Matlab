function [Experiment, NN, trials, Amp, FigsPath, Averaging, stackTrials] = getExperimentSpecs_TrapV(trialsfile, SubjIndex)
...
AmpCase = input('Which Amplitude would you want to examine?\n (1)deg\n (2)deg\n (5)deg\n (10)deg\n');
VelCase = input('Which Velocity would you want to examine? \n (2)dps\n (5)dps\n (10)dps\n');
