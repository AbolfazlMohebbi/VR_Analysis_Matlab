function Trials_Data_All = getTrialsData_AllSubj(Subject_No, Subject_data, flb_file_path_All, allData, trialsAll, VelCase, AmpCase)
...
for S = 1:Subject_No
    ...
    % Quiet Stance
%     QSdata = allData{1,S}(QS_trial_number).Data;
    QSdata = flb2mat(flb_file_path_All{S},'read_case',QS_trial_number);
    %QSdata = allData{1,S}.Data(QS_trial_number);
    ...
    for i = VelCase
        for j = AmpCase        
            ...
            data_trial = allData{S}(trialsAll{1,S}(i,j));
