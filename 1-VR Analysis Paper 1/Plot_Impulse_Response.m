...
% subplot(221)
% plot(irf_vr2tqL);
% title('IRF: VR to Torque Left');hold on
% 
% subplot(222)
% plot(irf_vr2tqR);
% title('IRF: VR to Torque Right');hold on
% 
% subplot(223)
% plot(irf_vr2shankL);
% title('IRF: VR to Left Shank Angle');hold on
% 
% subplot(224)
% plot(irf_vr2shankR);
% title('IRF: VR to Right Shank Angle');hold on
% set(gcf,'Units','Normalized','OuterPosition',[0 0 1 1])
...
% plot(vr2tqL_sim);
% title(['FR Simulated Model vs. Measured Left Torque, VAF = %' num2str(double(vaf_tqL),2)]);
% legend('Measured','IRF Simulated')
% 
% subplot(222)
% plot(TorqueR_decimated); hold on
% plot(vr2tqR_sim);
% title(['FR Simulated Model vs. Measured Right Torque, VAF = %' num2str(double(vaf_tqR),2)]);
% legend('Measured','Simulated')
% 
% subplot(223)
% plot(ShankL_decimated); hold on
% plot(vr2shankL_sim);
% title(['FR Simulated Model vs. Measured Left Shank Angle, VAF = %' num2str(double(vaf_shankL),2)]);
% legend('Measured','Simulated')
% 
% subplot(224)
% plot(ShankR_decimated);hold on
% plot(vr2shankR_sim);
% title(['FR Simulated Model vs. Measured Right Shank Angle, VAF = %' num2str(double(vaf_shankR),2)]);
% legend('Measured','Simulated')
% set(gcf,'Units','Normalized','OuterPosition',[0 0 1 1])
